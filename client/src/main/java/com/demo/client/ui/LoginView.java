...
public class LoginView {
  ...
  public LoginView(BiConsumer<String, String> onLogin) {
    ...
    loginBtn.setOnAction(e -> {
      ...
      var task = new Task<String>() {
        ...
        protected String call() throws Exception {
          // Register or verify role — backend enforces one role per email
          var result = api.registerUser(email, role);
          return result.role();
        }
      };
    ...
    card.getChildren().addAll(titleBox, emailLabel, emailField, roleLabel, roleRow, errorLabel, loginBtn);
